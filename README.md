...
This generator follows the [Angular Best Practice Guidelines for Project Structure](http://blog.angularjs.org/2014/02/an-angularjs-style-guide-and-best.html) and is a fork of [generator-cg-angular](https://github.com/cgross/generator-cg-angular)
...
Running a generator:
    ...
    yo ts-angular:directive my-awesome-directive
    yo ts-angular:partial my-partial
    yo ts-angular:service my-service
    yo ts-angular:filter my-filter
    yo ts-angular:module my-module
    yo ts-angular:modal my-modal
...
Submodules allow you to more explicitly separate parts of your application.  Use the `yo ts-angular:module my-module` command and specify a new subdirectory to place the module into.  Once you've created a submodule, running other subgenerators will now prompt you to select the module in which to place the new component.
...
* 9/06/2013 - V1.0.4 - Fixed templating issue with generated specs for `yo ts-angular:service` subgenerator.
